        ...
        {speakers.map((s, i) => (
          <div key={i} className={`speaker-card reveal reveal-delay-${i + 1}`}>
            ...
            <div className="speaker-info">
              ...
              <p className="speaker-desc">{s.description}</p>
            </div>
          </div>
        ))}
      </div>
